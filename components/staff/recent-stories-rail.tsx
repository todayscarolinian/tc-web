...
import { usePublishedArticles } from "@/src/entities/article/hooks/use-published-articles";

export function RecentStoriesRail() {
  const { data: published = [] } = usePublishedArticles();
  const articles = published.slice(0, 5);
